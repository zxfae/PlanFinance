...
impl FormModel {
    fn header() -> Html {
        ...
        html! {
            <header class="w-full text-center py-6 bg-gray-100">
                ...
                <a href="https://github.com/zxfae" class="text-gray-500 hover:text-gray-700" aria-label="My Github">
                    <svg width="90" height="90" viewBox="0 0 250 250" class="inline-block" style="fill:#fff; color:#304050; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
